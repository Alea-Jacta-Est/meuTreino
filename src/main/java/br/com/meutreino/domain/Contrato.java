...
public class Contrato implements Serializable {
	...
	@SequenceGenerator(name="contratoGenerator",sequenceName = "CONTRATO_SEQ", allocationSize = 10)
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "contratoGenerator")
